...
function readOnly(jwtKey) {
  ...
  routes.get('/file/:collectionName/:object_id/:file/:type/:prop/:number', handlers.handleGetOneFile);
  routes.get('/file/:collectionName/:object_id/:file/:type/:prop', handlers.handleGetOneFile);
  routes.post('/upload/:collectionName/:object_id/:prop', handlers.handleUploadPicture);
...
function all(jwtKey) {
  ...
  if (process.env.ALLOW_MULTIPLE_DELETES) {
